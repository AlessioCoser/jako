...
class TypedJoinTest {
    ...
    fun `parse inner join`() {
        ...
        assertEquals("""INNER JOIN "table" ON "field_original" = "field_table"""", join.toSQL())
    }
    ...
    fun `parse inner join USING`() {
        ...
        assertEquals("""INNER JOIN "table" USING("field")""", join.toSQL())
    }
    ...
    fun `left join`() {
        ...
        assertEquals("""LEFT JOIN "table" USING("field")""", join.toSQL())
    }
    ...
    fun `right join`() {
        ...
        assertEquals("""RIGHT JOIN "table" USING("field")""", join.toSQL())
    }
}
